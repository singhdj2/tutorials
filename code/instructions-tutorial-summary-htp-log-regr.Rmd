...
- Download data file residing inside the *data* directory *18LDH-tutorial-log-regression_2019-06-19.csv* and place it inside *htp-tutorials >> data* directory we just created on your computer during step 1 above 
- R markdown file inside the *code* directory *tutorial-summary-htp-log-regr.Rmd* and place it inside *htp-tutorials >> code*  


# 4. Install Packages in R-studio
Uncomment the following three lines of code >> copy-paste in R console >> hit ENTER button to install some required packages: 
``` {r}
